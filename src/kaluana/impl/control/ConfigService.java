...
/**
 * This class represents the Stub implementation on each ConfigService service 
 * @author hubertfonseca
 *
 */
public class ConfigService extends IConfigService.Stub {
	
	private Component component;
	
	public ConfigService(Component component, ContextWrapper contextWrapper) {
