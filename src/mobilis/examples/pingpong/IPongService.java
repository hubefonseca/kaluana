 ...
 * Original file: C:\\java\\android\\workspace\\mobilis\\src\\mobilis\\examples\\pingpong\\IPongService.aidl
 */
...
mobilis.examples.pingpong.IPongService in = (mobilis.examples.pingpong.IPongService)obj.queryLocalInterface(DESCRIPTOR);
if ((in!=null)) {
return in;
}
