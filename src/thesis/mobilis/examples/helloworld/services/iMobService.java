...
public static abstract class Stub extends android.os.Binder implements thesis.mobilis.examples.helloworld.services.iMobService
{
private static final java.lang.String DESCRIPTOR = "thesis.mobilis.examples.helloworld.services.iMobService";
 ...
 */
public static thesis.mobilis.examples.helloworld.services.iMobService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
thesis.mobilis.examples.helloworld.services.iMobService in = (thesis.mobilis.examples.helloworld.services.iMobService)obj.queryLocalInterface(DESCRIPTOR);
if ((in!=null)) {
return in;
}
return new thesis.mobilis.examples.helloworld.services.iMobService.Stub.Proxy(obj);
}
...
private static class Proxy implements thesis.mobilis.examples.helloworld.services.iMobService
{
