...
public static abstract class Stub extends android.os.Binder implements thesis.mobilis.api.control.IComponentLoaderListener
{
private static final java.lang.String DESCRIPTOR = "thesis.mobilis.api.control.IComponentLoaderListener";
 ...
 */
public static thesis.mobilis.api.control.IComponentLoaderListener asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
thesis.mobilis.api.control.IComponentLoaderListener in = (thesis.mobilis.api.control.IComponentLoaderListener)obj.queryLocalInterface(DESCRIPTOR);
if ((in!=null)) {
return in;
}
return new thesis.mobilis.api.control.IComponentLoaderListener.Stub.Proxy(obj);
}
...
private static class Proxy implements thesis.mobilis.api.control.IComponentLoaderListener
{
